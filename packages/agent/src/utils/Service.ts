...
export interface ServiceSection {
  ...
  */
  ...
  /**
   * @see {@link ServiceSection.ExecStartPre}
   */
 ...
 */
export const serviceSchema: ZodType<UnitService> = z.object({
  Unit: z.object({
    /**
     * Service name
     */
  ...
  Service: z.object({
    ...
    RemainAfterExit: z
      ...
      .optional(),
    /**
     * @see {@link ServiceSection.GuessMainPID}
     */
    GuessMainPID: z
      .boolean()
      .optional(),
    /**
     * @see {@link ServiceSection.PIDFile}
     */
    PIDFile: z.string().optional(),
    /**
     * @see {@link ServiceSection.BusName}
     */
    BusName: z.string().optional(),
    /**
     * @see {@link ServiceSection.ExecStart}
     */
...
export class Service {
  ...
  public toObject() {
    return serviceSchema.parse(this.service);
  }

  public fromObject(obj: unknown) {
    this.service = serviceSchema.parse(obj);
    return this;
  }
   ...
   * @see {@link ServiceSection.RemainAfterExit}
   */
  public setServiceRemainAfterExit(remainAfterExit: boolean) {
    this.service.Service.RemainAfterExit = remainAfterExit;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.GuessMainPID}
   */
  public setServiceGuessMainPID(guessMainPID: boolean) {
    this.service.Service.GuessMainPID = guessMainPID;
    return this;
  }
  /**
   * Set service PIDFile
   * @see {@link ServiceSection.PIDFile}
   */
  public setServicePIDFile(pidFile: string) {
    this.service.Service.PIDFile = pidFile;
    return this;
  }
  /**
   * Set service BusName
   * @see {@link ServiceSection.BusName}
   */
  public setServiceBusName(busName: string) {
    this.service.Service.BusName = busName;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecStart}
   */
  public setServiceExecStart(execStart: string | string[]) {
    this.service.Service.ExecStart = execStart;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecStartPre}
   */
  public setServiceExecStartPre(execStartPre: string | string[]) {
    this.service.Service.ExecStartPre = execStartPre;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecStartPre}
   */
  public setServiceExecStartPost(execStartPost: string | string[]) {
    this.service.Service.ExecStartPost = execStartPost;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecCondition}
   */
  public setServiceExecCondition(execCondition: string | string[]) {
    this.service.Service.ExecCondition = execCondition;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecReload}
   */
  public setServiceExecReload(execReload: string | string[]) {
    this.service.Service.ExecReload = execReload;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecStop}
   */
  public setServiceExecStop(execStop: string | string[]) {
    this.service.Service.ExecStop = execStop;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.ExecStopPost}
   */
  public setServiceExecStopPost(execStopPost: string | string[]) {
    this.service.Service.ExecStopPost = execStopPost;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.RestartSec}
   */
  public setServiceRestartSec(restartSec: string) {
    this.service.Service.RestartSec = restartSec;
    return this;
  }
  /**
   ...
   * @see {@link ServiceSection.TimeoutStartSec}
   */
  public setServiceTimeoutStartSec(timeoutStartSec: string) {
    this.service.Service.TimeoutStartSec = timeoutStartSec;
    return this;
  }
  /**
   * Set service TimeoutStopSec
   * @see {@link ServiceSection.TimeoutStopSec}
   */
  public setServiceTimeoutStopSec(timeoutStopSec: string) {
    this.service.Service.TimeoutStopSec = timeoutStopSec;
    return this;
  }
  /**
   * Set service TimeoutAbortSec
   * @see {@link ServiceSection.TimeoutAbortSec}
   */
  public setServiceTimeoutAbortSec(timeoutAbortSec: string) {
    this.service.Service.TimeoutAbortSec = timeoutAbortSec;
    return this;
  }
  /**
   * Set service TimeoutSec
   * @see {@link ServiceSection.TimeoutSec}
   */
  public setServiceTimeoutSec(timeoutSec: string) {
    this.service.Service.TimeoutSec = timeoutSec;
    return this;
  }
  /**
   ...
   */
  public setServiceWatchdogSec(watchdogSec: string) {
    this.service.Service.WatchdogSec = watchdogSec;
    return this;
  }
  /**
   * Set service Restart
   * @see {@link ServiceSection.Restart}
   */
   ...
   * @see {@link ServiceSection.SuccessExitStatus}
   */
  public setServiceSuccessExitStatus(successExitStatus: string) {
    this.service.Service.SuccessExitStatus = successExitStatus;
    return this;
  }
  /**
   * Set service RestartPreventExitStatus
   * @see {@link ServiceSection.RestartPreventExitStatus}
   */
  public setServiceRestartPreventExitStatus(restartPreventExitStatus: string) {
    this.service.Service.RestartPreventExitStatus = restartPreventExitStatus;
    return this;
  }
  /**
   * Set service RestartForceExitStatus
   * @see {@link ServiceSection.RestartForceExitStatus}
   */
  public setServiceRestartForceExitStatus(restartForceExitStatus: string) {
    this.service.Service.RestartForceExitStatus = restartForceExitStatus;
    return this;
  }
  /**
   * Set service RootDirectoryStartOnly
   * @see {@link ServiceSection.RootDirectoryStartOnly}
   */
  public setServiceRootDirectoryStartOnly(rootDirectoryStartOnly: boolean) {
    this.service.Service.RootDirectoryStartOnly = rootDirectoryStartOnly;
    return this;
  }
  /**
   * Set service NonBlocking
   * @see {@link ServiceSection.NonBlocking}
   */
