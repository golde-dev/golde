...
## [0.6.0](https://github.com/golde-dev/golde/compare/v0.5.0...v0.6.0) (2026-05-16)

### Features

* **cli:** add hcloud DNS zones and records ([bd957e6](https://github.com/golde-dev/golde/commit/bd957e6cb17bdef51095ea902d1ca5d27a08be4c)) - by @chyzwar
* **cli:** add hcloud sshKey resource and wire into example ([0a58be9](https://github.com/golde-dev/golde/commit/0a58be97aeedf4a96467aa5684a3b48adb6f6361)) - by @chyzwar
* **cli:** implement hcloud server resource and example ([bd6068e](https://github.com/golde-dev/golde/commit/bd6068eeb80f2d37c0762857548d09d7a2e0db77)) - by @chyzwar
* **docs:** scaffold top-level sidebar structure ([d46ed8c](https://github.com/golde-dev/golde/commit/d46ed8c85cfe4ffaa8fc44e89f2f3c8ffab1b5a8)) - by @chyzwar

## [0.5.0](https://github.com/golde-dev/golde/compare/v0.4.3...v0.5.0) (2026-05-01)

### Features

* **cli:** add --ignore-already-{created,deleted} flags and migrate http clients to ky ([e5178c9](https://github.com/golde-dev/golde/commit/e5178c9377056603567768feaea8ab2044569074)) - by @chyzwar

### Bug Fixes

* **cli:** close file stream before resolving in getFileHash ([3849f89](https://github.com/golde-dev/golde/commit/3849f8960f321e22a6e836127b5fc5d6d81160b3)) - by @chyzwar

## [0.4.3](https://github.com/golde-dev/golde/compare/v0.4.2...v0.4.3) (2026-03-25)

**Note:** Version bump only for package @golde/root

## [0.4.2](https://github.com/golde-dev/golde/compare/v0.4.1...v0.4.2) (2026-03-24)
